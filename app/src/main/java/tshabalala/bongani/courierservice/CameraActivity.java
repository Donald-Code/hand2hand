...
//
//        Log.e("Insta Token "," token "+ instanceid);
//        Log.e("Insta Role "," role "+ instanceid);
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            Intent intent = new Intent(CameraActivity.this, ChooseActivity.class);
        ...
        if ( mImageUri != null){
            ...
            uploadTask.addOnFailureListener(new OnFailureListener() {
                ...
                public void onFailure(@NonNull Exception exception) {
                    ...
                    Toast.makeText(CameraActivity.this, "Please upload a photo", Toast.LENGTH_SHORT).show();
                            ...
                            if (task.isSuccessful()) {
                                ...
                                String uid = String.valueOf(System.currentTimeMillis());
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        if(task.isSuccessful()){
                                            Intent intent = new Intent(CameraActivity.this, SignIn.class);
...
//                                                                    Toast.makeText(CameraActivity.this, getString(R.string.login_weak_password), Toast.LENGTH_SHORT).show();
//
...
//                                                                mDatabase.child(user.getUid()).removeValue();
//                                                                Toast.makeText(CameraActivity.this, getString(R.string.login_bad_email), Toast.LENGTH_SHORT).show();
//
//                                                            } else if (e instanceof FirebaseAuthUserCollisionException) {
//                                                                // editEmail.setError(getString(R.string.login_user_exists));
//                                                                mDatabase.child(user.getUid()).removeValue();
//                                                                Toast.makeText(CameraActivity.this, getString(R.string.login_user_exists), Toast.LENGTH_SHORT).show();
//
//                                                            }
//
//                                                        }
//                                                    });
                                           ...
                                           // mDatabase.child(user.getUid()).removeValue();
                                            Toast.makeText(CameraActivity.this, "User already exist!", Toast.LENGTH_SHORT).show();
            ...
            Toast.makeText(CameraActivity.this, "Please upload photo ", Toast.LENGTH_SHORT).show();
        }
    }
