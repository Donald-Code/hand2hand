...
public class ProfileEditInteractor {
     ...
     */
    public void getUserDataFromDb(String ref) {
        FirebaseUser user = FirebaseAuth.getInstance().getCurrentUser();
        final String uid = user.getUid();
        mDatabaseReference.child(ref).child(uid).addListenerForSingleValueEvent(
                new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        checkAndSetCurrentUserToken(uid,ref);
    ...
    private String checkAndSetCurrentUserToken(String userUid,String ref) {
        String instanceId = FirebaseInstanceId.getInstance().getToken();
        if(instanceId != null) {
            DatabaseReference mDatabaseReference = FirebaseDatabase.getInstance().getReference();
            mDatabaseReference.child(ref)
                    .child(userUid)
                    .child("instanceid")
                    .setValue(instanceId);
        }
     ...
     */
    public void updateUserDb(String ref) {
        final String userUid = mUser.getUid();
        mDatabaseReference.child(ref).child(userUid).
                addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        mDatabaseReference.child(ref).child(userUid).setValue(mUser);
