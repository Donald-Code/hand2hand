...
import tshabalala.bongani.courierservice.helper.DirectionsJSONParser;
import tshabalala.bongani.courierservice.helper.FirebaseOpsHelper;
import tshabalala.bongani.courierservice.model.NewOrder;
...
//                    PlaceAutocomplete.getPlace(mFragmentActivity, data).getLatLng().longitude);
    ...
    /**
     * Returns default coordinates (city of Pretoria)
    ...
    /**
     * Returns default LatLngBounds (area around Pretoria city)
     * Called from NewOrderPresenter.
     * @return LatLngBounds
     */
    private LatLngBounds getDefaultBounds() {
        return new LatLngBounds(new LatLng(25.7479, 28.2293), new LatLng(25.7479, 28.2293));
    }
